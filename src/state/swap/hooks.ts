...
import { useTradeExactIn, useTradeExactOut, useUniTradeExactIn, useUniTradeExactOut } from '../../hooks/Trades';
...
export function queryParametersToSwapState(parsedQs: ParsedQs, defaultToken?: string): SwapState {
...
export function useDefaultsFromURLSearch():
  ...
  useEffect(() => {
    if (!chainId) return;
    const parsed = queryParametersToSwapState(parsedQs, usdtAddress);
