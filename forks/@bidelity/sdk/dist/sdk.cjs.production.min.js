...
const kt = (function () {
  ...
  return (
    (e.minimumAmountOut = function (t) {
      ...
      const e = new at(g).add(t).invert().multiply(this.outputAmount.raw).quotient
    ...
    (t.bestTradeExactIn = function (e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === n || i.length > 0 || u(!1)
      const h = n instanceof dt ? n.token.chainId : r instanceof z ? r.chainId : void 0
      void 0 === h && u(!1)
    ...
    (t.bestTradeExactOut = function (e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === r || i.length > 0 || u(!1)
      const h = r instanceof dt ? r.token.chainId : n instanceof z ? n.chainId : void 0
      void 0 === h && u(!1)
  ...
  It = (function () {
    ...
    return (
      (t.swapCallParameters = function (t, e) {
        const n = t.inputAmount.currency === $,
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = '0x4D21B0E30d94f54ef9B5324709ceB5C06F86EBa8'),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
