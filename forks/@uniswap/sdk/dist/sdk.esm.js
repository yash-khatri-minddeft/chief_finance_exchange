...
var UniPair = /*#__PURE__*/function (_Pair) {
  ...
  function UniPair(tokenAmountA, tokenAmountB) {
    ...
    _this.liquidityToken = new Token(tokenAmounts[0].token.chainId, UniPair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'UNI-V2', 'Uniswap V2');
...
export { ChainId, ETHER, FACTORY_ADDRESS, Fetcher, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Rounding, Router, Trade, TradeType, UniPair, WETH, currencyEquals, inputOutputComparator, tradeComparator };
